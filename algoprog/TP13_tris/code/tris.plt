...
set style line 5 linetype 1 lw 1 linecolor rgb "brown" pointtype 2
set style line 6 linetype 1 lw 1 linecolor rgb "black" pointtype 1
set style line 7 linetype 1 lw 1 linecolor rgb "orange" pointtype 2
plot \
...
"./benchmark.txt" using 2:($1==2?$3:NaN) \
  title "tri rapide" with linespoints linestyle 3, \
"./benchmark.txt" using 2:($1==3?$3:NaN) \
  title "tri par insertion" with linespoints linestyle 4
